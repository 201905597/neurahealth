...
INSERT INTO EMOTIONDATES(EMOTION_NAME,FECHA,USER_ID) VALUES ('feliz',TO_DATE('04-30-2022', 'mm-dd-yyyy'),10001);
INSERT INTO EMOTIONDATES(EMOTION_NAME,FECHA,USER_ID) VALUES ('feliz',TO_DATE('05-01-2022', 'mm-dd-yyyy'),10001);
INSERT INTO EMOTIONDATES(EMOTION_NAME,FECHA,USER_ID) VALUES ('feliz',TO_DATE('05-02-2022', 'mm-dd-yyyy'),10001);
INSERT INTO EMOTIONDATES(EMOTION_NAME,FECHA,USER_ID) VALUES ('feliz',TO_DATE('05-03-2022', 'mm-dd-yyyy'),10001);